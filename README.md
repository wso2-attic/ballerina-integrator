...
- As the first step you can build a Ballerina executable archive (.balx) of the service that we developed above. Navigate to the `asynchronous-invocation/guide` folder and run the following commands. 
