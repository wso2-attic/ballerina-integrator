...
mysql:Client employeeDB = new({
        host: config:getAsString("DATABASE_HOST", defaultValue = "${databaseHost}"),
        port: config:getAsInt("DATABASE_PORT", defaultValue = ${databasePort}),
        name: config:getAsString("DATABASE_NAME", defaultValue = "${databaseName}"),
        username: config:getAsString("DATABASE_USERNAME", defaultValue = "${databaseUsername}"),
        password: config:getAsString("DATABASE_PASSWORD", defaultValue = "${databasePassword}"),
