...
function testAddOperation () {
    map<json> inputJson = {"operation":"add", "valueOne": 40, "valueTwo": 50};
    int expectedResponse = 90;

    var response = calculatorEP->post("/calculate", inputJson);
...
function testSubtractOperation () {
    map<json> inputJson = {"operation":"subtract", "valueOne": 40, "valueTwo": 50};
