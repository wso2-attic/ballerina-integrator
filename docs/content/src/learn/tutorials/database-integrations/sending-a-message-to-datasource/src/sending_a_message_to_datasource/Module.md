Guide on Sending Messages to Datasources.
...
- Download and run the **Doctors.sql** script file located inside the resources directory to create the backend database.
...
```
$ ballerina new sending-a-message-to-datasource
```
