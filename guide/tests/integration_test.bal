...
function testStockSummaryService() {
    ...
    test:assertTrue(serviceStarted1, msg = "Unable to start stock_quote_summary_service");
    test:assertTrue(serviceStarted2, msg = "Unable to start stock_quote_data_backend");
